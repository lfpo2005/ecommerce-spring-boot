...
public class WebConfigSecurity extends WebSecurityConfigurerAdapter implements HttpSessionListener {
    ...
    private final ImpleUserDetailsService impleUserDetailsService;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().csrfTokenRepository(CookieCsrfTokenRepository.withHttpOnlyFalse())
                ...
                /** redireciona ou retorna para o index quando desloga */
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth.userDetailsService(impleUserDetailsService).passwordEncoder(new BCryptPasswordEncoder());
    }
